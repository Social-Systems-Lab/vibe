...
import { useVibe, VibeProvider } from "../vibe/react.tsx"; // Import useVibe hook AND VibeProvider
import type { Unsubscribe, AppManifest } from "../vibe/types"; // Import types

// Define the manifest for this test application (same as in frontend.tsx for now)
// TODO: Consider moving this to a shared location if needed elsewhere
const testAppManifest: AppManifest = {
    appId: "test-app-local",
...
function AppContent() {
    ...
    const handleWriteTask = useCallback(async () => {
        ...
        try {
            ...
            console.log("[AppPage] Task written:", result);
        } catch (error) {
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card className="bg-card/50 backdrop-blur-sm border-muted">
                    <CardHeader>
                        <CardTitle>Tasks (Subscription / Write)</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="flex gap-2 mb-4">
