        ...
        .group("/certs", (app) =>
            app
                ...
                .post(
                    ...
                    async ({ profile, body, set }) => {
                        try {
                            const certType = await certsService.createCertType(body, profile as JwtPayload);
                    ...
                    },
                    {
                        body: t.Object({
                            ...
                            badgeIconUrl: t.Optional(t.String()),
                ...
                .get(
                    ...
                    async ({ profile, params, set }) => {
                        try {
                            const certType = await certsService.getCertType(params.id, profile as JwtPayload);
                            return { success: true, certType };
                        } catch (error: any) {
                            set.status = 500;
                            return { error: error.message };
                ...
                .put(
                    ...
                    async ({ profile, params, body, set }) => {
                        try {
                            const certType = await certsService.updateCertType({ ...body, _id: params.id }, profile as JwtPayload);
                            return { success: true, certType };
                        } catch (error: any) {
                            set.status = 500;
                            return { error: error.message };
                ...
                .delete(
                    ...
                    async ({ profile, params, set }) => {
                        try {
                            await certsService.deleteCertType(params.id, profile as JwtPayload);
                            return { success: true };
                        } catch (error: any) {
                            set.status = 500;
                            return { error: error.message };
