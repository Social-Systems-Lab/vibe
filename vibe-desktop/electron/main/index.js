...
const webview_preload = join(__dirname, "../preload/webview-preload.js");
...
async function createWindow() {
    ...
    win.on("blur", () => {
        win?.webContents.send("fromMain", { type: "window-blur" });
    });
}
...
app.whenReady().then(() => {
    ...
    startWatchingAccountsDirectory(win);
});
...
ipcMain.handle("get-config", (event) => {
    return {
        webviewPreloadPath: webview_preload,
        appPath: __dirname,
