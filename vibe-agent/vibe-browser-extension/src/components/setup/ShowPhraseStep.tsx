...
export function ShowPhraseStep({ mnemonic, onPhraseConfirmed }: ShowPhraseStepProps) {
    ...
    return (
        <div className="flex flex-col items-center justify-start h-full p-6 space-y-5 text-center">
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-md space-y-4 pt-2">
                ...
                <Button type="submit" className="w-full py-3 text-base" disabled={!hasConfirmedBackup}>
